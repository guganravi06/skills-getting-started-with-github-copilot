...
activities = {
    ...
    "Basketball Team": {
        "description": "Team training, drills, and inter-school basketball matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Soccer Club": {
        "description": "Skill-building sessions and friendly soccer games",
    ...
    "School Choir": {
        "description": "Practice vocal techniques and perform at school events",
